    ...
    return (
        <ImageBackground source={require('../../assets/bg.png')} style={styles.container}>
            <View style={styles.headerContainer}>
                ...
                <TransText style={[styles.welcome, props.locale == "ar" && { textAlign: 'right' }]} transkey={"FORGOT_PASSWORD_TITLE"} />
            </View>
            ...
            <View style={styles.signinContainerWhite}>
                ...
                <TouchableOpacity
                    activeOpacity={0.8}
                    onPress={() => {
                        props.dispatch(Actions.forgotPasswordAttempt(email));
                    }}
                    disabled={!email || props.attempting}
                    style={styles.loginBtn}>
                    {props.attempting ?
                        <ActivityIndicator size={theme.xxl} color={"#fff"} />
                        :
                        <TransText style={styles.btntext} transkey="NEXT" />}
                </TouchableOpacity>
