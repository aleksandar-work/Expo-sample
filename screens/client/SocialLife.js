                ...
                >
                    <DialogContent style={{ height: hp(60), width: wp('85%'), justifyContent: 'space-evenly' }}>
                        ...
                        <View style={{ marginLeft: wp(7), width: '80%', height: hp(7), borderBottomColor: '#e5e5e5', borderBottomWidth: 1 }}>
                            ...
                            <Text style={{ paddingLeft: 5, fontFamily: theme.pop, color: theme.secondary, fontSize: theme.medium,marginTop:hp(1) }}>{appRedData.name}</Text>
                        ...
                        <View style={{ flexDirection: 'row', marginTop: hp(3) }}>
                            <View style={{ marginLeft: wp(7), width: '40%', height: hp(7), borderBottomColor: '#e5e5e5', borderBottomWidth: 1 }}>
                                ...
                                <Text style={{ paddingLeft: 5, fontFamily: theme.pop, color: theme.secondary, fontSize: theme.medium,marginTop:hp(1) }}>{parseInt(appRedData.time.slice(0, 2)) < 12 ? appRedData.time.slice(0, 5) + ' ' + 'AM' : parseInt(appRedData.time.slice(0, 2)) - 12 + appRedData.time.slice(2, 5) + ' ' + 'PM'}</Text>
                            ...
                            <View style={{ marginLeft: wp(1), width: '40%', height: hp(7), borderBottomColor: '#e5e5e5', borderBottomWidth: 1 }}>
                                ...
                                <Text style={{ paddingLeft: 5, fontFamily: theme.pop, color: theme.secondary, fontSize: theme.medium,marginTop:hp(1) }}>{appRedData.date.split("/")[2] + '-' + appRedData.date.split("/")[1] + '-' + appRedData.date.split("/")[0]}</Text>
                        ...
                        <View style={{ flexDirection: 'row', marginTop: hp(3) }}>
                            <View style={{ marginLeft: wp(7), width: '40%', height: hp(7), borderBottomColor: '#e5e5e5', borderBottomWidth: 1 }}>
                                ...
                                <Text style={{ paddingLeft: 5, fontFamily: theme.pop, color: theme.secondary, fontSize: theme.medium,marginTop:hp(1) }}>{appRedData.location}</Text>
                            ...
                            <View style={{ marginLeft: wp(1), width: '40%', height: hp(7), borderBottomColor: '#e5e5e5', borderBottomWidth: 1 }}>
                                ...
                                <Text style={{ paddingLeft: 5, fontFamily: theme.pop, color: theme.secondary, fontSize: theme.medium,marginTop:hp(1) }}>{appRedData.city}</Text>
                        ...
                        <View style={{ paddingRight: 5, marginTop: hp(3), marginLeft: wp(7), width: '80%', height: hp(10), borderBottomColor: '#e5e5e5', borderBottomWidth: 1 }}>
                            ...
                            <Text style={{ paddingLeft: 5, fontFamily: theme.pop, color: theme.secondary, fontSize: theme.small / 1,marginTop:hp(1) }}>{appRedData.note}</Text>
