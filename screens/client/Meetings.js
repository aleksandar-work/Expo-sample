        ...
        return (
            <ImageBackground source={require('../../assets/bg.png')} style={styles.container}>
                ...
                <View style={styles.body}>
                    ...
                    <TouchableOpacity onPress={()=>navigation.navigate('MeetingForm')} style={styles.topButton}>
                ...
                <View style={styles.itemContainer}>
                     ...
                     <Text style={styles.firstText}>{item.meeting_name}</Text>
                     </View>
             ...
             {appRedData ? 
               <Dialog
                    ...
                    <Text style={{paddingLeft:5,fontFamily:theme.pop,color:theme.secondary,fontSize:theme.medium}}>{appRedData.meeting_name}</Text>
                    ...
                    <Text style={{paddingLeft:5,fontFamily:theme.pop,color:theme.secondary,fontSize:theme.medium}}>{appRedData.location}</Text>
