...
const FooterSecretary = (props) => {
    const navigation = useNavigation();
    return (
        <View style={styles.container}>
            <TouchableOpacity onPress={() => navigation.navigate('Profile')} hitSlop={{ top: 15, left: 15, right: 15, bottom: 15 }}>
                <Feather name="home" size={24} color={theme.primary} />
            </TouchableOpacity>
            <TouchableOpacity onPress={() => navigation.navigate('ContactSecretary')} hitSlop={{ top: 15, left: 15, right: 15, bottom: 15 }}>
...
export default FooterSecretary;
